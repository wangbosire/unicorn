      ...
      items: [
        {
          ...
          icon: Boxes,
          anyOfPermissions: ['collections.read'],
        },
        {
          title: '内容复核',
          url: '/collections/reviews',
          icon: ScanSearch,
          anyOfPermissions: ['collection_reviews.read'],
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          anyOfPermissions: ['collection_comments.read'],
        },
        {
          title: '评论审核',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: KeyRound,
          anyOfPermissions: ['permissions.read'],
        },
        {
          title: '变更日志',
          url: '/system/authorization-change-logs',
          icon: HistoryIcon,
          anyOfPermissions: ['permissions.read'],
        },
        {
          ...
          icon: KeyRound,
          anyOfPermissions: ['permission_groups.read'],
        },
        {
          title: '菜单权限',
          url: '/system/menus',
