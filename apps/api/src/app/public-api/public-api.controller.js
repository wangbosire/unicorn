...
var PublicApiController = function () {
    var _classDecorators = [(0, common_1.Controller)('public-api')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _getHealth_decorators;
    var PublicApiController = _classThis = /** @class */ (function () {
        function PublicApiController_1() {
            __runInitializers(this, _instanceExtraInitializers);
        }
        PublicApiController_1.prototype.getHealth = function () {
            return { scope: 'public-api', status: 'ok' };
        };
        return PublicApiController_1;
    }());
