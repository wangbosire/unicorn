            ...
            items: [
              {
                ...
                unissuedActivationCodesCount: 5,
                issuedActivationCodesCount: 2,
                usedActivationCodesCount: 3,
                voidedActivationCodesCount: 1,
                expiredActivationCodesCount: 1,
                pendingClaimCollectionsCount: 5,
                claimedCollectionsCount: 5,
                frozenCollectionsCount: 2,
                status: 'ENABLED',
