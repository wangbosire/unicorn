...
- 涉及开发顺序、阶段目标、里程碑、验收标准时，优先查看 `docs/执行计划.md`、`docs/exec-plans/active/二期准备与文档收口计划.md` 与 `docs/exec-plans/completed/一期V1归档总览.md`
...
当前仓库的一期主链路与运营治理能力已完成收口，处于“文档归档整理与二期准备”阶段：
...
当前优先级以文档收口、归档导航、技术债治理和后续阶段规划为主，详细内容以 `docs/` 为准。
